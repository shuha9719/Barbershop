// Коллаж: одно широкое фото (1536x1024) с тремя панелями.
// В каждой панели — тот же человек с одной из рекомендованных стрижек.
exports.handler = async (event) => {
  ...
  try {
    ...
    // styles: [{ name: 'Кроп', description: '...' }, ...] — до 3 штук
